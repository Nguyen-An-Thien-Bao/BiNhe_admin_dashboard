    ...
    return (
        <>
            <aside
                ...
                } z-20 ease-in-out duration-300 fixed top-0 left-0 bottom-0 min-w-40 min-h-full bg-primary-green shadow-lg shadow-black text-white dark:bg-primary-black`}
            >
